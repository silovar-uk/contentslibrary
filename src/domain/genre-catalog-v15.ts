...
export const GENRE_CATALOG_V15 = [
  ...
  { id: "mystery", name: "ミステリー", color: "#7A3B5A", aliases: ["ミステリー", "推理", "サスペンス"] },
  { id: "sf", name: "SF", color: "#2F5F7A", aliases: ["SF", "サイエンス・フィクション"] },
  { id: "fantasy", name: "ファンタジー", color: "#5A6E3B", aliases: ["ファンタジー"] },
  { id: "romance", name: "恋愛", color: "#B4576F", aliases: ["恋愛", "ラブストーリー"] },
  { id: "essay", name: "エッセイ", color: "#B65F47", aliases: ["エッセイ", "随筆", "ドキュメンタリー", "体験談", "コラム", "オムニバス"] },
  ...
  { id: "psychology", name: "心理・認知", color: "#39766F", aliases: ["心理・認知", "心理", "認知", "心理学", "脳科学", "神経科学"] },
  ...
  { id: "art", name: "芸術・デザイン", color: "#7650A0", aliases: ["芸術・デザイン", "芸術", "デザイン", "アート", "写真", "音楽"] },
